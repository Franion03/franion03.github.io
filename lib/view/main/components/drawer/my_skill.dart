...
class AnimatedLinearProgressIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    child: TweenAnimationBuilder(tween: Tween(begin: 0.0,end: percentage), duration: const Duration(seconds: 1), builder: (context, dynamic value, child) {
        return Column(
          children: [
            Row(
              children: [
                ...
                const Spacer(),
                Text('${((value as double)*100).toInt().toString()}%'),
              ],
            ),
